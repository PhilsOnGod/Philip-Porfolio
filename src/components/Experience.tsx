...
const experiences = [
  {
    ...
    company: "Chudy Bros Enterprise",
    location: "Nigeria",
    period: "2019 – 2023",
    description: "Managed business operations, coordinated client relationships, oversaw day-to-day activities, and drove sales and growth strategies for the enterprise.",
    skills: ["Business Ops", "Client Management", "Sales", "Strategy"],
    current: false,
  },
  {
    type: "work",
    title: "Software Intern & Office Assistant",
    company: "Femish IT Solution",
    location: "Ikeja, Lagos",
    period: "2022 – 2023",
    description: "Provided IT support, assisted with software development tasks, handled administrative duties, and supported client-facing operations.",
    skills: ["IT Support", "Software Dev", "Admin", "Client Ops"],
    current: false,
  },
  {
    type: "education",
    title: "B.Sc. Computer Science",
    company: "Achievers University, Owo",
    location: "Ondo, Nigeria",
    period: "Graduated 2024",
    description: "Graduated with Second Class Upper Division. Built a strong foundation in programming, web development, and database management through coursework and projects.",
    skills: ["Programming", "Web Dev", "Databases"],
    current: false,
  },
  {
    type: "work",
    title: "NYSC Service Member",
    company: "Emaayo Model School",
    location: "Ogun State",
    period: "2024 – 2026",
    description: "Coordinated training programmes, liaised with stakeholders, and successfully organised a community trade fair in Yewa South, Ogun State.",
    skills: ["Coordination", "Stakeholder Mgmt", "Event Planning"],
    current: true,
  },
];
