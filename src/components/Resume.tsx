        ...
        >
          <div className="tech-card cyber-corner rounded-2xl p-6 md:p-8">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="w-14 h-16 md:w-20 md:h-24 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-lg flex items-center justify-center border border-primary/30 animate-pulse-glow">
                <FileText className="w-6 h-8 md:w-10 md:h-12 text-primary" />
              </div>
              <div className="flex-1">
                <h3 className="font-bold text-lg md:text-2xl text-foreground terminal-text">OKEKE PHILIP CHIDUBEM</h3>
                <p className="text-primary text-sm font-medium">Full Stack Web Developer</p>
                <p className="text-xs text-muted-foreground mt-1 hidden md:block">Lagos, Nigeria • Ongod7238@gmail.com</p>
              </div>
            </div>

            {/* Quick Highlights - Horizontal on mobile */}
            <div className="overflow-x-auto scrollbar-hide -mx-2 px-2 mb-6">
              <div className="flex gap-3 min-w-max md:min-w-0 md:grid md:grid-cols-3">
                {highlights.map((item, index) => (
                  <div 
                    key={index}
                    className="flex-shrink-0 w-28 md:w-auto text-center p-3 md:p-4 bg-muted/30 rounded-xl border border-border/30"
                  >
                    <item.icon className="w-4 h-4 md:w-6 md:h-6 text-primary mx-auto mb-1" />
            ...
            <Button 
              ...
              className="w-full bg-gradient-to-r from-primary via-accent to-secondary hover:opacity-90 text-primary-foreground font-medium py-5 md:py-6 rounded-xl shadow-glow transition-all duration-300 hover:shadow-primary/40 animate-cyber-border"
            >
